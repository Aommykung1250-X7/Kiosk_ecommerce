...
export interface Product {
  ...
  /**
   * สินค้าเพิ่งเพิ่มเข้าระบบไม่เกิน 3 วันหรือไม่ — หลังบ้านคิดสดจาก created_at ทุกครั้ง
   * (backend/src/services/newArrivalService.js) ไม่ใช่ค่าที่เก็บไว้ในฐานข้อมูล
   */
  isNew?: boolean;
}
